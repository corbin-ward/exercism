defmodule RationalNumbers do
  ...
  def reduce(a) do
    common_divisor = Kernel.abs(_gcd(a))
    {a1, a2} = a
    if a2 < 0 do
      {div(a1, common_divisor) * -1, div(a2, common_divisor) * -1}
    else
      {div(a1, common_divisor), div(a2, common_divisor)}
    end
  end
end
